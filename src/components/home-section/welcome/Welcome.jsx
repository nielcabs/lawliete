            ...
            <div className="welcome__info relative">
                <div className="welcome__info__content">
                    <div className="title">
                        ...
                        <h2 className="main-color">Lawliete Guild</h2>
                    </div>
                    <div className="description m-t-4">
                        Ang guild na madami ginagawa pero masipag. Ako'y isang pinoy may pusong cheesecake. Sa aming bahay puno ng bangkay, Merry Christmas Puno ng Singkamas, Ang pag ibig puno ng tubig.
                    </div>
